...
?>
    ...
    <div class="form-group">
    	<div class="col-md-6">
		   	<label class="control-label" for="pregunta5">5. Calidad de las acciones formativas impartidas por ESFOCC:</label></div>
	    	<div class="col-md-6">
		    	<label class="radio-inline">
    ...
    <div class="form-group">
    	<div class="col-md-6">
		   	<label class="control-label" for="pregunta6">6. Relación calidad precio de los servicios prestados:</label></div>
	    	<div class="col-md-6">
		    	<label class="radio-inline">
    ...
    <div class="form-group">
    	<div class="col-md-6">
		   	<label class="control-label" for="pregunta7">7. Grado de organización de las acciones formativas:</label></div>
	    	<div class="col-md-6">
		    	<label class="radio-inline">
	...
	<input name="tabla" type="hidden" id="tabla" value="cuestionarios_evaluacion" />
...
<script>
		...
		$(document).on("click", "a#guardacuestionario", function(event){
			...
			$.ajax({
				...
				data: values+'&guardacuestionario=1',
