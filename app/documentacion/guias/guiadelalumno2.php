   ...
   <page backleft="40px" backright="40px" backtop="140px" backbottom="60px" pagegroup="new">
    ...
    <page backleft="40px" backright="40px" backtop="140px" backbottom="60px">
        ...
        <page_footer>
            ...
            <ol class="listaindice">
                ...
                <li>Tiempo de conexión al curso: mínimo 30% de la duración total del curso. </li>
    ...
    $content = ob_get_clean();
        ...
        if ( !isset($_POST[enviomail]) )
            ...
            if ( $naccion != '1008' ) {
                $mail->addAttachment($nombreFichero);
                $titulo = $mail->Subject = 'Access codes online course '.$naccion.'.'.$ngrupo.' - '.$alumno;
                $mail->Body = 'Dear student,<br><br>
                Attached to this email we send you the access codes to the online course that will start with us shortly.<br><br>
                * If you are copying and pasting your passwords to access, make sure that you copy only the username and password characters, and not the blank spaces, if you write them by hand, respect the upper and lower case.<br><br>';
            ...
            if ($url == "http://campus2.eduka-te.com/") {
                ...
                $mail->Body .= '
                <h3 style="margin-top: 15px" class="tituloseccion">Course Data</h3>
                <table class="listadatos">
                
                <tr><td>Start date </td><td style="font-weight: bold">'. $fechaini .'</td></tr>
                <tr><td>End date </td><td style="font-weight: bold">'. $fechafin .'</td></tr>';

                if ($modalidad == "Teleformación") {
                    $mail->Body    .= '<tr><td>Link: </td><td style="font-weight: bold">'. $url .'</td></tr>
                    <tr><td>User: </td><td style="font-weight: bold">'. $user .'</td></tr>
                    <tr><td>Password: </td><td style="font-weight: bold">'. $pass .'</td></tr>';
                }
