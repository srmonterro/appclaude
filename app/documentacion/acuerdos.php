...
Puede consultar la información adicional y detallada sobre Protección de Datos en nuestra página web: http://edukate.avisolegal.info/.</p>
        ...
        <div style="margin-top: 80px">
                <table>
                    ...
                    <tr><td text-align="right" colspan="4"><strong>EDUKA-TE SOLUTIONS, S.L.U.</strong></td></tr>
                </table>
        </div>
    ...
    <page backleft="60px" backright="60px" backtop="200px" backbottom="60px">
        ...
        <div style="margin-top: 120px">
                ...
                <tr><td text-align="right" colspan="4"><strong>Eduka-te Solutions, sl.</strong></td></tr>
                    <tr>
                        <td><img style="width: 200px;" src="../img/sello_edukate.png"></td>
                    </tr>
