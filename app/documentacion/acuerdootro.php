...
// $fecha = date("Y-m-d");
	$nombreFichero = "AcuerdoOtro_".$row[nombre].".pdf";    
    ob_start();
...
.letrafooter {
    ...
    <page backimg="./fondo_doc.jpg" backimgx="center" backimgy="bottom" backimgw="100%" backleft="60px" backright="60px" backtop="50px" backbottom="60px">
        ...
        <p>De una parte, D. <strong>José Daniel Álvarez Benítez</strong>, con DNI 78565562T, en representación <strong>ESCUELA SUPERIOR DE FORMACIÓN Y CUALIFICACIÓN DE CANARIAS, S.L.</strong> con C.I.F.:B76567718 y domicilio en C/El Sol 10, 38204 – San Cristóbal de La Laguna, en adelante <strong>ESFOCC</strong>.</p><br>
    ...
    <? if ( $row[estipulaciones] != "" ) { ?>
       <p>- <?  echo nl2br ($row[estipulaciones]) ?></p> <? } ?>

    <p>- ESFOCC. abonará a la ASESORIA en concepto de honorarios por <? echo $row[otro] ?> un <span style="font-weight: bold; text-decoration: underline;">15% del importe facturado y cobrado por cada curso</span>.</p>
	<p>- La forma de pago de dichos honorarios será mediante <? echo $_GET[formapago] ?> con un plazo de pago de <? echo $_GET[vencimiento] ?> días fecha factura.</p><br><br>
	...
	<p style="margin-top: 60px">- La duración de este acuerdo de colaboración será de un año a partir de la fecha, prorrogable  por igual periodo,  sino se mediara denuncia entre las partes con dos meses de antelación.</p><br>

	<p>- Los datos de carácter personal que sean recabados por ESFOCC de los clientes de la ASESORÍA, serán incorporados a un fichero automatizado, con la finalidad de realizar acuerdos de formación, pudiendo ejercitar los derechos de acceso, rectificación, oposición y cancelación de los mismos de acuerdo con la legislación vigente.</p><br>

	<p>-Para cualquier duda o divergencia sobre este contrato, las partes se someten al Fuero de los Tribunales de Santa Cruz de Tenerife.</p><br>
