...
// function generaDiplomaBonif($id_mat, $id_emp, $link) {
    ...
    if ( $naccion == '17' || $naccion == '106' ) 
        $clase = "../img/diplomas/dipfront_nobonif_incen1.png";
    else if ( $naccion == '18' ) 
        $clase = "../img/diplomas/dipfront_nobonif_incen2.png";
    else if ( $naccion == '1001' || $naccion == '1006' || $naccion == '1017') {
        // echo $ngrupo;
        if ( $ngrupo == '22p' )
            $clase = "../img/diplomas/dipfront_nobonif_lopesan.png";
        else
        $clase = "../img/diplomas/dipfront_nobonif_incen_1001.png";
    } else 
        $clase = "../img/diplomas/dipfront_nobonif.png";



if ( $estado == 'Finalizada' || $estado == 'Facturada' || $grupal == 1 )
