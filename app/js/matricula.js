$(document).ready(function() {
	...
	$(".abrebusqueda, #abrebusqueda").on('click', function(event) {
		...
		if ( $(this).attr('name') != undefined ) { //viene de matricula
			...
			//cgutierrez: pruebas para control de facturación
			//alert("Sección: "+$(location).attr('href').split("?"));
	...
	$(document).on("click", "#imprimirsm", function(event) {

		var id = $('.bloquemat #id').val();
		var numero = $('#numero').val();

		var url = 'http://gestion.eduka-te.com/app/documentacion'+gestion+'/solicitudes/'+numero+'/'+numero+'-matricula.pdf';
//
		if ( doesFileExist(url) === true ) {
			window.open('http://gestion.eduka-te.com/app/documentacion'+gestion+'/solicitudes/'+numero+'/'+numero+'-matricula.pdf', '_blank');
		} else {
			window.open('http://gestion.eduka-te.com/app/documentacion/imprimirSM.php?id='+id, '_blank');
		}
	...
	$(document).on("click","#imprimirmat", function (event) {
		...
		var id_matricula = $('#id_matricula').val();
		window.open('http://gestion.eduka-te.com/app/functions/imprimirMat.php?id_matricula='+id_matricula, '_blank');
	...
	$(document).on("click", "#vin", function(event) {
		...
		var id_matricula = $('#id_matricula').val();
		// alert(id_matricula);
		// window.open('http://gestion.eduka-te.com/app/documentacion/generar_diploma_td.php?id_matricula='+id_matricula, '_blank');


		if ( sec[1] == 'form_matricula_doc' || sec[1] == 'form_matricula_doc#' )
			window.open('http://gestion.eduka-te.com/app/documentacion/diplomas/certificado_imparticion.php?id_matricula='+id_matricula, '_blank');
	...
	$(document).on("click", "#enviodiplotd", function(event) {
		...
		$.ajax({
			...
			data: 'id_matricula='+id_matricula+'&anio='+gestion+'&envio=1',
			success: function(data)
			{
				if ( data == "bien" )
					alert("Email Enviado.")
		...
		// window.open('http://gestion.eduka-te.com/app/documentacion/generar_diploma_tdn.php?id_matricula='+id_matricula+'&envio=1', '_blank');
	...
	$(document).on("click", "#diplomatdgo", function(event) {
		...
		window.open('http://gestion.eduka-te.com/app/documentacion/generar_diploma_tdn.php?id_matricula='+id_matricula, '_blank');
  ...
  //       form.submit();
		...
		// window.open('http://gestion.eduka-te.com/app/documentacion/generar_diploma_tdn.php?id_matricula='+id_matricula+'&fuente='+fuente, '_blank');
	...
	$(document).on("click", "#verguia", function(event) {
		...
		window.open('http://gestion.eduka-te.com/app/documentacion/guias/guiadelalumno.php?id_matricula='+id_matricula, '_blank');
	...
	$(document).on("click", "#guia_generica", function(event) {

		event.preventDefault();
		var id_accion = $('#id').val();

		window.open('http://gestion.eduka-te.com/app/documentacion/guias/guiagenerica.php?id='+id_accion, '_blank');
	...
	$(document).on("click", "#guiadelalumnomtodos", function(event) { // SOLO FUNCIONA CON POCOS ALUMNOS - PDFS
		...
		var id_matricula = $('#id_matricula').val();
		window.open('http://gestion.eduka-te.com/app/documentacion/guias/guiadelalumnomixto.php?id_matricula='+id_matricula, '_blank');
	...
	$(document).on("click", "#guiadelalumnomp", function(event) {
		...
		if ( sec[1] == 'form_matricula_doc' || sec[1] == 'matricula' ) {
			var mod = 'o';
			window.open('http://gestion.eduka-te.com/app/documentacion/guias/guiadelalumno.php?id_matricula='+id_matricula+'&id_alumno='+id_alumno+'&user='+user+'&pass='+pass+'&mod='+mod+'&tipo='+tipo, '_blank');
		}
		else {
			var mod = 'p';
			window.open('http://gestion.eduka-te.com/app/documentacion/guias/guiadelalumnomixtoind.php?id_matricula='+id_matricula+'&id_alumno='+id_alumno+'&user='+user+'&pass='+pass+'&mod='+mod+'&tipo='+tipo, '_blank');
		}
	        ...
	        success: function(data)
	        {
	        	...
	        	if ( (data[0].disponible == "0" || data[0].disponible === null) && $('select#tipo_formacion').val() == 'Bonificable'  && $('#numeroaccion').val() < 5000 ) {
					...
					if ( ei < 5 ) {
			            ...
			            for ( var j = 0; j < data['numerocuenta'].length; j++ ) {
		            		$('#numerocuenta'+i).removeAttr('readonly').prop('required',true).append('<option value="'+data['numerocuenta'][j].numerocuenta+'">'+data['numerocuenta'][j].numerocuenta+'</option>');
		            	}
					}
				}
				}
    ...
    $(document).on("click", "#mat-seleccionardocente, #matoini-seleccionardocente", function(event){
    	...
    	var input_docente = '<div class="clearfix"></div><div id="doc'+k+'"><input name="id_docente[]" type="hidden" id="id_docente'+k+'" value=""/><input name="perfil[]" n="'+k+'" type="hidden" id="perfil'+k+'" value=""/><div class="col-md-2"><div class="form-group"><label class="control-label" for="nombred'+k+'">Nombre:</label><input type="text" id="nombred'+k+'" name="nombred'+k+'" class="required form-control" readonly/></div></div><div class="col-md-2"><div class="form-group"><label class="control-label" for="apellidod'+k+'">Apellido:</label><input type="text" id="apellidod'+k+'" name="apellidod'+k+'" class="form-control" readonly/></div></div><div class="col-md-3"><div class="form-group"><label class="control-label" for="documentod'+k+'">Nº Documento:</label><input type="text" id="documentod'+k+'" name="documentod'+k+'" class="required form-control" readonly/></div></div><div class="col-md-2"><div class="form-group"><label class="control-label" for="numhorasdoc'+k+'">Nº Horas:</label><input type="text" id="numhorasdoc'+k+'" name="numhorasdoc[]" class="required form-control" /></div></div><div class="col-md-2"><div class="form-group"><label class="control-label" for="perfiles'+k+'">Perfil:</label><select id="perfiles" name="perfiles" class="required form-control" ><option value="">Selecciona</option><option value="3">Formador / Dinamizador</option><option value="1">Formador</option></select></div></div><div class="col-md-1"><a href="#" id="eliminardoc'+k+'" class="eliminard btn btn-xs btn-danger"><span class="glyphicon glyphicon-remove"></span> </a></div></div>';
	...
	$(document).on("change", "select#perfiles", function(event){
		// console.log("eee");
		var n = $(this).attr('n');
		console.log($(this).val());
		console.log($('div#doc_'+k+' input#perfil'+k).attr('name'));
		$('#perfil'+k).val($(this).val());
    ...
    $(document).on("click", "#mat-seleccionarmat", function(event){
    	...
    	$.ajax({
	        ...
	        success: function(data)
	        {
	            ...
	            $('#cobservacionesfin,#cobservacionesfinamanda,#divaf_factura').css('display','block');
	...
	$(document).on("click", "#btncredenciales", function(event){
		...
		$.ajax({
	        ...
	        success: function(data)
	        {
	            ...
	            $('a#enviaguiagrupoindv').attr('tipo', $('#tipo').val() );
	        }
    	});
	...
	// $(document).on("dblclick", "#fungibledidac", function(event){

	// 	var id_matricula = $('#id_matricula').val();

	// 	//alert(id_matricula);

	// 	insertarFungibles(id_matricula);

	// });

	// $(document).on("dblclick", "#otrosgastos", function(event){

	// 	var id_matricula = $('#id_matricula').val();

	// 	//alert(id_matricula);

	// 	insertarOtrosGastos(id_matricula);

	// });

	// cgutierrez - guardar los items fungibles para imputarlos a la matrícula
	function insertarFungibles(id){
	...
	function insertarOtrosGastos(id){
