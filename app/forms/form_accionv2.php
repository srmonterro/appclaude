	...
	<div class="col-md-4">
    	<div class="form-group">
		    <label class="control-label" for="modalidad">Tipo y Modalidad:</label>
		    <select id="modalidad" name="modalidad" class="form-control">
		    	<option value="">Por asignar</option>
		    	<option value="BonifPresencial">Bonificado y Presencial</option>
		    	<option value="BonifTeleformación">Bonificado y Teleformación</option>
                <option value="PrivPresencial">Privado y Presencial</option>
		    	<option value="PrivTeleformación">Privado y Teleformación</option>
                <option value="Valora">A Distancia</option> -->
		    	<option value="Nordotel">Mixta</option>-->
		   	</select>
	    </div>
	</div>
	<!--<div class="col-md-2">
    	<div class="form-group">
		    ...
		    <select id="tipoformacionac" name="tipoformacionac" class="form-control">
				...
				<option value="Nordotel">Nordotel</option>
	...
	<div class="col-md-2">
    	<div class="form-group">
		    ...
		    <select id="url" name="url" class="form-control">
		    	...
		    	<option value="https://eduka-te.dexway.com">Dexway</option>
		    	<option value="https://www.trainingeduka-te.com/">Moodle</option>
	...
	<? if ( $_SESSION['anio'] > "2016" ) { ?>
	<div class="col-md-6">
    	<div class="form-group">
		    <label class="control-label" for="area_profesional">Área Profesional:</label>
		    <select id="area_profesional" name="area_profesional" class="form-control">
		    	<?

			    		$q = 'SELECT codigo, area
						FROM area_profesional
						ORDER BY area ASC';
						...
						while ( $row = mysqli_fetch_assoc($q) ) {
							...
							echo '<option value="'.$row['codigo'].'">'.$row['area'].'</option>';
	...
	<!-- <div class="col-md-2" style="margin-top: 25px">
		<a id="guia_generica" style="float:none;" href="#" class="btn btn-sm btn-success">Guía</a>
	</div> -->
