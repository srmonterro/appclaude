...
<!--     <div style="display:none" id="confirmacion" class="inv alert alert-success">Progreso guardado. Acuérdate de ir actualizándolo a medida que el alumno va avanzando en la formación.</div>
	...
	<ol class="breadcrumb">
      <li>Seguimiento</li>
      <li class="active">Seguimiento Comisionistas</li>
	</ol>
	...
	<form role="form" action="" method="post" id="form-seguimiento">
	        ...
	        <div class="cp form-group">
   			...
   			<div class="input-group">
		      	...
		      	<span class="input-group-btn">
		        	<button id="buscarcomisionista" name="buscarcomisionista" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></button>
		      	</span>
		    </div>
   			</div>
	    </div>
		...
		<div class="col-md-1">
			<a style="margin-top: 24px; width:100%;" id="busqueda-seguimientoco" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></a>
		</div>
...
$(document).on("click", "#busqueda-seguimientoco", function(event) {
	...
	$.ajax({
		cache: false,
		type: 'POST',
		url: 'functions/busqueda-seguimientoc.php',
		data: values,
