...
<!-- 		<div class="col-md-2">
 ...
 -->		<div class="col-md-2">
		...
		<div class="col-md-1">
			<a style="margin-top: 24px; width:100%;" id="busqueda-seguimientoinci" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></a>
		</div>
...
$(document).on("click", "#busqueda-seguimientoinci", function(event) {
...
// alert(values);
	$.ajax({
		cache: false,
		type: 'POST',
		url: 'functions/busqueda-seguimientoinci.php',
		data: values,
