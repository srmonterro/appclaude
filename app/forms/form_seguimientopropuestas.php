...
<!--     <div style="display:none" id="confirmacion" class="inv alert alert-success">Progreso guardado. Acuérdate de ir actualizándolo a medida que el alumno va avanzando en la formación.</div>
	...
	<ol class="breadcrumb">
      <li>Seguimiento</li>
      <li class="active">Seguimiento Propuestas</li>
	</ol>
	...
	<form role="form" action="" method="post" id="form-seguimiento">
		...
		<div class="col-md-1">
			<a style="margin-top: 24px; width:100%;" id="busqueda-seguimientoprop" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></a>
		</div>
...
$(document).on("click", "#busqueda-seguimientoprop", function(event) {
	...
	$.ajax({
		cache: false,
		type: 'POST',
		url: 'functions/busqueda-seguimientoprop.php',
