    ...
    <div class="col-lg-2 col-sm-6">
        <div class="circle-tile">
            ...
            <div class="circle-tile-content dark-blue">
                ...
                <a href="https://gestion.eduka-te.com/app/index.php?seguimiento-indicadores" class="circle-tile-footer">Más info <i class="fa fa-chevron-circle-right"></i></a>
            </div>
        </div>
    </div>
    <div class="col-lg-2 col-sm-6">
        <div class="circle-tile">
            ...
            <div class="circle-tile-content green">
                <div class="circle-tile-description text-faded">
                    Presencial <? echo $gestion ?>
                </div>
                <div class="circle-tile-number text-faded">
                <? echo $alumnospresencial ?>
                </div>
                <a href="https://gestion.eduka-te.com/app/index.php?seguimiento-indicadores" class="circle-tile-footer">Más info <i class="fa fa-chevron-circle-right"></i></a>
            </div>
        </div>
...
<!--<ol class="breadcrumb">
      <li class="">Gestión</li>
      <li class="active">Panel de Bienvenida</li>
</ol>
<h3 style="margin-bottom:40px">Hola, <? echo $_SESSION['user'] ?> 👋 </h3>-->
<h3 style="margin-bottom:40px">Hola👋 </h3>
