...
<div class="col-md-2">
	<div class="form-group">
		<label class="control-label" for="tipoformacionikea">Tipo de Formación:</label>
		<select id="tipoformacionikea" name="tipoformacionikea" class="form-control">
...
<input name="tabla" type="hidden" id="tabla" value="propuestas" />
...
<div id="uploaderapp" style="display:none; margin-top:20px ">

	<div class="col-md-2 col-md-offset-2">
		<a style=" margin-top: 25px" id="modeloexcel" class="boton btn btn-primary"><span class="glyphicon glyphicon-save"></span> Plantilla Excel </a>
	</div>

	<form id="formparticipantesapp" action="" method="post" enctype="multipart/form-data">
		<label> Tabla de participantes: </label><br>
		<input style="float:left" type="file" name="participantesikea" id="participantesikea" class="btn btn-default">
		<a id="subirtablaikea" class="boton btn btn-primary"><span class="glyphicon glyphicon-open"></span> Subir PDF </a>
		<a id="mostrartablaikea" style="" class="boton btn btn-success"><span class="glyphicon glyphicon-save"></span> Mostrar PDF </a><span style="margin-top: 10px; margin-left: 5px; color: red;" class="glyphicon glyphicon-ok-circle"></span>
	</form>
	<form id="formparticipantesapp" action="" method="post" enctype="multipart/form-data">
		<label> Tabla de participantes: </label><br>
		<input style="float:left" type="file" name="participantesikea" id="participantesikea" class="btn btn-default">
