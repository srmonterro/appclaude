...
<!--     <div style="display:none" id="confirmacion" class="inv alert alert-success">Progreso guardado. Acuérdate de ir actualizándolo a medida que el alumno va avanzando en la formación.</div>
    ...
    <ol class="breadcrumb">
      <li>Facturación</li>
      <li class="active">Seguimiento Devoluciones</li>
    </ol>
...
<!--         <div class="col-md-3" style="margin-top: 20px;">
        ...
        <div class="col-md-1">
            <a style="margin-top: 24px; width:100%;" id="busqueda-seguimientodevol" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></a>
        </div>
