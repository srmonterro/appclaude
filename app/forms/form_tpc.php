...
<form class="formulariotpc" id="formulario" role="form" action="" method="post">
	<div style="margin-top: 30px" class="container">
		...
		<div class="diplomastpc col-md-2" style="display:none">
			<a id="diplomastpc" style="float:left; width:100%"  class="btn btn-sm btn-warning">Diplomas</a>
		</div>
		<div class="listadostpc col-md-2" style="display:none">
			<a id="listadostpc" style="float:left; width:100%"  name="matriculas" data-toggle=modal class="btn btn-sm btn-success">Listados</a>
		</div>
	...
	<div class="col-md-3">
		<div class="from-group">
			<label class="control-label" for="centrostpc">Centro:</label>
			<select id="centrostpc" name="centrostpc" class="form-control">
				<option value="">-</option>
	...
	<div class="col-md-6">
		<div class="form-group cp">
			<label class="control-label" for="numeroaccion">Matrícula:</label>
			<div class="input-group">
				<input placeholder="Busca por Accion/Grupo" id="numeroaccion" name="numeroaccion" class="form-control">
				<span class="input-group-btn">
					<button id="buscarmatricula" name="buscarmatricula" class="btn btn-default" nuevo="">
						<span class="glyphicon glyphicon-search"></span></button>
					</span>
				</div>
			</div>
		</div>
		<input type="hidden" value="" id="id_mat" name="id_matricula" class="form-control">


		<div class="clearfix"></div>

		<div class="col-md-6">
			<label class="control-label" for="docentestpc">Docentes:</label>
			<select class="multiselect" id="docentestpc" name="docentestpc" multiple="multiple" style="display: none;">
				<option value="">-</option>
		...
		<!--MODIFICACION HECHA POR OCTAVIO 7/4/2017-->
		<div class="col-md-12">
			<div class="form-group">
				<label class="control-label" for="observaciones">Observaciones</label>
				<textarea id="observaciones" name="observaciones" class="form-control" style="resize:none;" rows="4"></textarea>
			</div>
		</div>
	...
	<input name="tabla" type="hidden" id="tabla" value="cursos_tpc" />
...
<div class="col-md-7 col-md-offset-3 tablatpc" style="margin-bottom: 15px; display:none;">
	<form id="formtablatpc" action="" method="post" enctype="multipart/form-data">
		<label> Tabla TPC: </label><br>
		<input style="float:left" type="file" name="tablatpc" id="tablatpc" class="btn btn-default">
		<a id="subirtablatpc" class="boton btn btn-primary"><span class="glyphicon glyphicon-open"></span> Subir Excel </a>
		<a id="mostrartablatpc" style="" class="boton btn btn-success"><span class="glyphicon glyphicon-save"></span> Mostrar Excel </a><span id="estatablatpc" style="margin-top: 10px; margin-left: 5px; color: red;" class="glyphicon glyphicon-ok-circle"></span>
	</form>
</div>
