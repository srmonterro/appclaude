<div style="margin-top: 45px" class="container">
    ...
    <div style="display:none" id="confirmacion" class="alert alert-success">Matrícula finalizada correctamente.</div>
...
<form class="formulariopresencial_fin" id="formulario" role="form" action="" method="post">
    ...
    <div id="datosaccion" style="display:none">
            ...
            <input type="hidden" id="estado" value="" disabled>
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="hidden" id="esikea" name="esikea" class="form-control" value=""/>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
...
<div class="col-md-12">
    ...
    <fieldset class="fieldbonif">
        ...
        <a id="subirexcel_fin" href="#" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-open"></span> Subir Excel</a>
        <a id="leerexcel_fin" style="" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-list-alt"></span> Leer Excel</a>
        <a id="cargardatos" style="" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-save"></span> Cargar Datos</a>
        <!--<a id="xmlfinpre" style="display:none" class="btn btn-sm btn-info"> XML Fin</a>-->
        <a id="xmlfinprepost" style="display:none" class="btn btn-sm btn-info"> XML Fin RD</a>
        <? if ( $_SESSION['user'] == 'root' || $_SESSION['user'] == 'amanda' || $_SESSION['user'] == 'alago' || $_SESSION['user'] == 'melody' ) { ?>
...
<div class="col-md-12">
    ...
    <fieldset>
        ...
        <a id="subirexcel_fin_privado" href="#" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-open"></span> Subir Excel</a>
        <a id="leerexcel_fin_privado" style="" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-list-alt"></span> Leer Excel</a>
        <a id="cargardatos_fin_privado" style="" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-save"></span> Cargar Datos</a>
