...
<!--     <div style="display:none" id="confirmacion" class="inv alert alert-success">Progreso guardado. Acuérdate de ir actualizándolo a medida que el alumno va avanzando en la formación.</div>
    ...
    <form role="form" action="" method="post" id="form-seguimiento">
        ...
        <div class="col-md-2">
            <div class="form-group">
                <label class="control-label" for="denominacion">Denominación AF:</label>
        ...
        <div class="col-md-1">
            <div class="form-group">
                <label class="control-label" for="numero">Nº Fra:</label>
...
<!--         <div class="col-md-3" style="margin-top: 20px;">
        ...
        <div class="col-md-2">
            <div class="form-group">
                    <label class="control-label" for="facturar_a">¿Facturado a...?</label>
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" id="importe_a_abonar" name="importe_a_abonar" class="form-control" />
            </div>
        </div>
        <div class="col-md-1">
        ...
        <div class="col-md-2">
             <div class="form-group">
                    <label class="control-label" for="anio_vencimiento">Año Vencimiento:</label>
                    <select id="anio_vencimiento" name="anio_vencimiento" class="form-control" >
                        <option value="">Cualquiera</option>

                        <?

                        for ($i = $gestion; $i < $gestion+2; $i++) {
                        ...
                        if ( $_SESSION[user] == 'amparo' ) {
                            ...
                            echo '<option value="">Cualquiera</option>';
                                ...
                                while ( $row = mysqli_fetch_array($q) )  {
                                    ...
                                    if ( $row[nombre] == ucfirst($_SESSION[user]) || $_SESSION[user] == 'daniel' || $_SESSION[user] == 'rmedina' || $_SESSION[user] == 'cristina' || $_SESSION[user] == 'root' ) {
        ...
        <div class="col-md-2">
             <div class="form-group">
                    <label class="control-label" for="mes_factura">Mes Factura:</label>
                    <select id="mes_factura" name="mes_factura" class="form-control" >
                        <option value="">Cualquiera</option>
                        <option value="1">Enero</option>
                        <option value="2">Febrero</option>
                        <option value="3">Marzo</option>
    ...
    <div class="col-md-6">
        <table id="leyenda" style="display:none">
            <tr>
                ...
                <td> | </td>
                <td style="color:#ccc">Pagada de más</td>
                <td> | </td>
    ...
    <? if ( $_SESSION['user'] != 'root' || $_SESSION['user'] == 'cristina' ) { ?>
    <div class="col-md-2 pull-right">
        <a id="generar_remesa" style="width:100%; margin-top: 0px; margin-left:15px; display: none" class="pull-left btn btn-primary btn-success"><span class="glyphicon glyphicon-euro"></span> Remesa</a>
    </div>
    <? } ?>
    <div class="col-md-2 pull-right">
        <a id="imprimirSeguimientoc" onclick="printDiv('listado-seguimiento')" style="display: none; width:100%" class="pull-right btn btn-primary btn-default"><span class="glyphicon glyphicon-print"></span> Imprimir</a>
    </div>
    <div class="col-md-2 pull-right">
        <a id="listadoExcel" style="display: none; width:100%" class="pull-right btn btn-primary btn-default"><span class="glyphicon glyphicon-list-alt"></span> Exportar a Excel</a>
    </div></div>
    <div class="clearfix"></div>
