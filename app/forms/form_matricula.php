...
<form class="formulariomatricula" id="formulario" role="form" action="" method="post">
<div style="margin-top: 45px" class="container">
	...
	<input type="hidden" name="mat_indiv" id="mat_indiv" value="1" />

	<div class="col-md-10 btnmatriculas" style="float:left; min-height:70px; display:none; text-align: left">
		<a id="imprimirmat" style="float:none;" href="#" class="btn btn-sm btn-success">Imprimir</a>
		<? if ( $gestion == "2014" ) { ?>
		...
		<? } else { ?>
		<a id="diplomatdn" style="display:none; float:none; margin-left:5px;" href="#" name="matriculas" data-toggle=modal class="btn btn-sm btn-success">Diploma</a><? } ?>
		<a id="vin" style="display:none; float:none; margin-left:5px;" href="#" name="matriculas" data-toggle=modal class="btn btn-sm btn-success">VIN</a>
		<a id="guiadelalumno" style="display:none; float:none; margin-left:5px;" href="#" name="matriculas" data-toggle=modal class="btn btn-sm btn-success">Guía</a>
		<!-- <a id="informe-conex" style="float:none; margin-left:5px;" href="#" name="matriculas" data-toggle=modal class="btn btn-sm btn-success">Conexiones</a> -->
		<a id="informe-online" style="float:none; margin-left:5px;" href="#" name="matriculas" data-toggle=modal class="btn btn-sm btn-success">Informe</a>
		...
		<!-- <a id="xmlfin" style="float:none; margin-left:5px;" href="#" name="matriculas" data-toggle=modal class="btn btn-sm btn-warning">XML Fin Pre RD</a> -->
		<a id="xmlfin_post" style="float:none; margin-left:5px;" href="#" name="matriculas" data-toggle=modal class="btn btn-sm btn-warning">XML Fin Post RD</a>
		<a id="preacuerdo" style="float:none; margin-left:5px;" href="#" name="matriculas" data-toggle=modal class="btn btn-sm btn-warning">Acuerdo</a>
		...
		<a id="costesfactuind" style="display:none; float:none; margin-left:5px;" href="#" name="matriculas" data-toggle=modal class="btn btn-sm btn-warning">Costes</a>
	</div>
	...
	<div style="float:left; min-height: 30px; " class="col-md-2">
    	<div class="form-group botones">
	...
	<fieldset>
	    <a href="#" data-toggle=modal id="btndocentese" class="abrebusqueda btn btn-default"><span class="glyphicon glyphicon-pencil"></span> Docentes</a>
...
<!-- 		   	</div>
 ...
 -->
	...
	<fieldset>
		...
		<div class="col-md-3">
		    	<div class="form-group">
				    <label class="control-label" for="costes_organizacion">Costes Organización:</label>
				    <input type="text" id="costes_organizacion" name="costes_organizacion" class="form-control" />
			    </div>
		</div>
		<div class="col-md-3">
		    	<div class="form-group">
				    <label class="control-label" for="costes_indirectos">Costes Indirectos:</label>
				    <input type="text" id="costes_indirectos" name="costes_indirectos" class="form-control" />
			    </div>
		</div>
		<div class="col-md-3">
		    	<div class="form-group">
				    <label class="control-label" for="importe_a_bonificar">Importe a Bonificar:</label>
				    <input type="text" id="importe_a_bonificar" name="importe_a_bonificar" class="form-control" />
			    </div>
		</div>

		<div id="ctipofra" style="margin-top: 0px; display: inline-block;" class="col-md-3">
		    <div class="form-group">
	...
	<div id="cobservacionesfin" style="margin: 20px 0 20px 0; display:none" class="ta col-md-12">
        <div class="form-group">
	...
	<div class="clearfix"></div>
	<div id="cobservacionesfinamanda" style="margin-top: 20px;margin-bottom: 20px; display:none" class="ta col-md-9">
	    <div class="form-group">
    ...
    <fieldset>
    	...
    	<div style="" class="ta col-md-10">
    		<div class="form-group">
    			<label class="control-label" for="incidenciasfinamanda">Incidencias Finalización Amanda:</label>
    			<textarea name="incidenciasfinamanda" id="incidenciasfinamanda" class="form-control" rows="2"></textarea>
    	   </div>
    	</div>
    	<div style="" class="ta col-md-2">
	        <div style="margin-top: 25px">
	        	<a id="guardarincidenciasfinamanda" style="" class="btn btn-success"> Guardar Observaciones</a>
	        </div>
        </div>
    <div class="clearfix"></div>
    </fieldset>
